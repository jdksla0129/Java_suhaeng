...
public class Tomato {
    ...
    @Builder
    public Tomato(String title, String content, int wateringCount, int leafCount, boolean pruned, int date, String time,int fruit, Weather weather, int temperature, Dust dustConcentration) {
        this.title = title;
